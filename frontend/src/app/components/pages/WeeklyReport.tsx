      ...
      <div className="bg-card/80 backdrop-blur-sm border-b border-border px-6 py-4">
        <div className="max-w-4xl mx-auto flex justify-between items-center">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-xl">Weekly Wellness Report</span>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-6 py-8">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary/10 rounded-full mb-4">
            ...
            <span className="text-sm text-primary">Last 7 Days Analysis</span>
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-4">
            <button
              ...
              className="flex items-center justify-center gap-2 py-4 bg-primary text-primary-foreground rounded-xl hover:bg-primary/90 transition-all duration-300"
            >
              <MessageCircle className="w-5 h-5" />
              Talk to AI Assistant
            </button>
            <button
              onClick={isSevere ? () => onNavigate("clinic-locator") : undefined}
              disabled={!isSevere}
        ...
        >
          <button
            onClick={() => onNavigate("journal")}
            className="inline-flex items-center gap-2 px-6 py-3 bg-muted hover:bg-muted/80 rounded-xl transition-all duration-300"
          >
